    ...
    <div className='relative py-16 md:py-24'>
      ...
      <div className='md:hidden'>
        <div className='relative max-w-3xl mx-auto pl-6'>
          <div className='absolute left-3 top-0 bottom-0 w-0.5 bg-amber-500 dark:bg-amber-600' />
          <div className='space-y-10'>
            {events.map((event) => (
              <div key={event.year} className='relative pl-8'>
                <div className='absolute left-0 top-3 w-3 h-3 rounded-full bg-amber-500 dark:bg-amber-600 border-2 border-black dark:border-black' />
                <div className='bg-zinc-900/60 dark:bg-zinc-900/60 backdrop-blur-sm border border-zinc-800/60 dark:border-zinc-800/60 rounded-xl p-5 shadow-lg'>
                  <Typography
                    variant='caption1'
                    className='text-amber-500 dark:text-amber-400 uppercase tracking-wider font-semibold text-xs mb-2'
                  >
                    {event.year}
                  </Typography>
                  <Typography
                    variant='body1'
                    className='text-zinc-50 font-semibold text-lg mb-2'
                  >
                    {event.title}
                  </Typography>
                  <Typography
